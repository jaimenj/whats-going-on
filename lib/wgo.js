...
function wgoMain() {
    ...
    jQuery('body').on('click', '#wgo-btn-show-ips', function () {
        jQuery('.wgo-box').addClass('wgo-d-none');
        jQuery('.wgo-box-ips').removeClass('wgo-d-none');
    });
    ...
    jQuery('body').on('click', '#wgo-btn-show-lasts', function () {
        jQuery('.wgo-box').addClass('wgo-d-none');
        jQuery('.wgo-box-lasts').removeClass('wgo-d-none');
    });
}
